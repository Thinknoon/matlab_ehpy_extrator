{
    "name": "ID.LIP_20201103L3.SC_ATAC_GEX_COUNTER_CS.SC_ATAC_GEX_COUNTER._ATAC_MATRIX_COMPUTER._PEAK_CALLER.DETECT_PEAKS.fork0.chnk18",
    "pid": 277657,
    "host": "localhost",
    "type": "local",
    "cwd": "/mnt/usb3/LIP_20201103L3/SC_ATAC_GEX_COUNTER_CS/SC_ATAC_GEX_COUNTER/_ATAC_MATRIX_COMPUTER/_PEAK_CALLER/DETECT_PEAKS/fork0/chnk18-u72b3783d00/files",
    "python": {
    ...
    "io": {
        ...
        "max": {
            "read": {
                "sysc": 12440.6022068785,
                "bytes": 0
            },
            "write": {
                "sysc": 826.2970598366699,
                "bytes": 0
            }
        },
        "dev": {
            "read": {
                "sysc": 4019.8358389152604,
                "bytes": 0
            },
            "write": {
                "sysc": 121.8622593038529,
                "bytes": 0
            }
        }
    },
    "wallclock": {
        ...
        "end": "2022-11-19 16:08:47",
        "duration_seconds": 441.517615346
    },
    "threads": 1,
    "memGB": 8,
    "vmemGB": 11,
